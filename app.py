...
CID_GRUPOS = {
    ...
    'C': "Neoplasias", 'D': "Doenças do Sangue / Neoplasias",
    ...
    'M': "Doenças Osteomusculares", 'N': "Doenças Geniturinária",
...
if 'arquivo_selecionado' in st.session_state:
    ...
    if df is not None and not df.empty:
        ...
        st.markdown("<h1>CAGEPA - RHLI - Dashboard de Afastamentos Médicos</h1>", unsafe_allow_html=True)
