...
st.set_page_config(
    page_title="CAGEPA - RHLI - Dashboard de Afastamentos Médicos",
    page_icon=" ",
    layout="wide",
...
CID_NOMES = {
    ...
    'C22':'Neo. maligna do fígado','C25':'Neo. maligna do pâncreas',
...
st.sidebar.markdown("<h2 style='color: #1e3a5f; margin-bottom: 2rem;'>Dashboard de Afastamentos Médicos</h2>", unsafe_allow_html=True)
st.sidebar.markdown("---")
...
st.sidebar.markdown("---")
st.sidebar.markdown("<p style='color: #64748b; font-size: 0.8rem;'>© 2026 - Coordenação de Recursos Humanos do Litoral - RHLI</p>", unsafe_allow_html=True)
...
if 'arquivo_selecionado' in st.session_state:
    ...
    st.markdown("<h1>Dashboard de Atestados Médicos</h1>", unsafe_allow_html=True)
    st.markdown("---")
